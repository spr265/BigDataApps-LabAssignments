...
public class FindingMatches {
    public static void main(String args[]) throws IOException {
        MBFImage image1 = ImageUtilities.readMBF(new File("input/chimp1.jpg"));
        MBFImage image2 = ImageUtilities.readMBF(new File("input/chimp2.jpg"));
...
System.out.println(targetKeypoints);
/*
