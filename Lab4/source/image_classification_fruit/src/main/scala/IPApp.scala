...
object IPApp {
  ...
  val IMAGE_CATEGORIES = List("Apples","Banana","grapes","guava","oranges","pineapple")
  ...
  def main(args: Array[String]) {
    ...
    bw.newLine()
    bw.write("Precision:" + metrics.weightedPrecision)
    bw.newLine()
    bw.write("FMeasure:" + metrics.weightedFMeasure)
    bw.newLine()
    bw.write("Recall:" + metrics.weightedRecall)
    bw.newLine()
