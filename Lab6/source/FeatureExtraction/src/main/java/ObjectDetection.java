...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/hcl.mkv"));
        int count1 = 0, count2 = 0, count3 = 0;
        String o1 = "output/testfeatures2.txt";
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/new124.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("data/new125.jpg"));
            modelImage3 = ImageUtilities.readMBF(new File("data/new167.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
