...
public final class RecognizeConceptsActivity extends BaseActivity {
  ...
  protected void onStart() {
    ...
    resultsList.setAdapter(com.example.putha.clarifai_fuzzy_android.adapter);
  }
  ...
  private void onImagePicked(@NonNull final byte[] imageBytes) {
    ...
    com.example.putha.clarifai_fuzzy_android.adapter.setData(Collections.<Concept>emptyList());
    ...
    new AsyncTask<Void, Void, ClarifaiResponse<List<ClarifaiOutput<Concept>>>>() {
      ...
      protected void onPostExecute(ClarifaiResponse<List<ClarifaiOutput<Concept>>> response) {
        ...
        com.example.putha.clarifai_fuzzy_android.adapter.setData(predictions.get(0).data());
